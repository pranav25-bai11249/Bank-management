# Bank-management
Bank management system is made for client bank server interaction
It includes the following features create a new account, deposit money, withdraw money, apply for loan, repay the loan

Technologies used
random  module for creating account number and CIF number
lists for storing data of accounts, loan, CIF numbers and account numbers
while loop for repeating tasks
Visual Studio Code for compiling and running
